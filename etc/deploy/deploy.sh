...
scp -o ProxyCommand="ssh -W %h:%p deploy@estadisticas.arte-consultores.com" metamac-sso-web/target/authentication-service-internal-*.war deploy@estadisticas.arte.internal:$TRANSFER_PATH/authentication-service-internal.war
